...
public class PropertyReader {
    ...
    */
    ...
    private static volatile com.ultimateqa.courses.propertyreader.PropertyReader propInstance;
     ...
     * @return
     */
    public static synchronized com.ultimateqa.courses.propertyreader.PropertyReader getInstance() {
        if (propInstance == null) {
            propInstance = new com.ultimateqa.courses.propertyreader.PropertyReader();
        }
        return propInstance;
    }
