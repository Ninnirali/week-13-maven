...
public class PropertyReader {
    ...
    */
    ...
    private static volatile htm.index.parabank.com.parasoft.parabank.propertyreader.PropertyReader propInstance;
     ...
     * @return
     */
    public static synchronized htm.index.parabank.com.parasoft.parabank.propertyreader.PropertyReader getInstance() {
        if (propInstance == null) {
            propInstance = new htm.index.parabank.com.parasoft.parabank.propertyreader.PropertyReader();
        }
        return propInstance;
    }
