package com.oranghrmlive.demo_opensource.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    private static volatile com.oranghrmlive.demo_opensource.propertyreader.PropertyReader propInstance;
     ...
     * @return
     */
    public static synchronized com.oranghrmlive.demo_opensource.propertyreader.PropertyReader getInstance() {
        if (propInstance == null) {
            propInstance = new com.oranghrmlive.demo_opensource.propertyreader.PropertyReader();
        }
        return propInstance;
    }
