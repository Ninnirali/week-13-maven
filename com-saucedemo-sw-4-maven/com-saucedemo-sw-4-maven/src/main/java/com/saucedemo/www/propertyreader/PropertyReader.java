...
public class PropertyReader {
    ...
    */
    ...
    private static volatile com.saucedemo.www.propertyreader.PropertyReader propInstance;
     ...
     * @return
     */
    public static synchronized com.saucedemo.www.propertyreader.PropertyReader getInstance() {
        if (propInstance == null) {
            propInstance = new com.saucedemo.www.propertyreader.PropertyReader();
        }
        return propInstance;
    }
