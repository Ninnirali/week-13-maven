...
public class PropertyReader {
    ...
    */
    ...
    private static volatile com.cart_x.mobile.propertyreader.PropertyReader propInstance;
     ...
     * @return
     */
    public static synchronized com.cart_x.mobile.propertyreader.PropertyReader getInstance() {
        if (propInstance == null) {
            propInstance = new com.cart_x.mobile.propertyreader.PropertyReader();
        }
        return propInstance;
    }
